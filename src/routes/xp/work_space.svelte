<script>
    ...
    async function launch(program){
        ...
        } else if(path == './programs/faqs.svelte'){
            const Program = (await import('./programs/faqs.svelte')).default;
            let program = new Program({
                target: node_ref,
                props: {id: short.generate(), parentNode: node_ref, exec_path: path}
            });
        ...
        } else if(path == './programs/prizes.svelte'){
            const Program = (await import('./programs/prizes.svelte')).default;
            let program = new Program({
                target: node_ref,
                props: {id: short.generate(), parentNode: node_ref, exec_path: path}
            });
        ...
        } else if(path == './programs/team_formation.svelte'){
            const Program = (await import('./programs/team_formation.svelte')).default;
            let program = new Program({
                target: node_ref,
                props: {id: short.generate(), parentNode: node_ref, exec_path: path}
            });
        ...
        } else if(path == './programs/about_us.svelte'){
            const Program = (await import('./programs/about_us.svelte')).default;
            let program = new Program({
                target: node_ref,
                props: {id: short.generate(), parentNode: node_ref, exec_path: path}
            });
    ...
    async function get_url(item){
        //null lets internet_explorer.svelte fall back to its own homepage
