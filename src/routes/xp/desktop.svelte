<script>
    ...
    //open the CODEUTSAVA app automatically once the welcome screen clears
    function open_homepage(){
        queueProgram.set({path: './programs/codeutsava.svelte'});
    }
...
<Welcome bind:this={welcome_scene} on_destroyed={open_homepage} />
