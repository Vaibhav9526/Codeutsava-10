<script>
    ...
    let blacked_out = false;
    function blackout(){
        //'ended' and the fallback timer race - whoever gets here first wins
    ...
    onMount(async () => {
        ...
        let shutdown_audio = play_sound('/audio/xp_shutdown.mp3');
        ...
        //never strand the user on "Windows is shutting down..." if the sound is blocked
        setTimeout(blackout, 9000);
    })
